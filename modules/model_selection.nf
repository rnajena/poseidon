process model_selection {
    ...
    (echo "${aln}"; echo "${tree}"; echo "${params.model_rate_classes}"; echo "${params.model_selection_method}"; echo "${params.model_rejection_level}"; echo "${name}.result") | hyphy mt > model.txt
